...
class TabBarController : UITabBarController {
    ...
    let payTab = UINavigationController(rootViewController: MainViewController())
    ...
    let payTabBarItem = UITabBarItem(title: "토스페이", image: Image.tossPay, tag: 2)
    let stockTabBarItem = UITabBarItem(title: "주식", image: Image.stock, tag: 2)
    let financialTipsTabBarItem = UITabBarItem(title: "금융팁", image: Image.financialTip, tag: 2)
